                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      >
                        <option value="">--select--</option>
                        <option value="Engineering">Manufacturing</option>
                        <option value="Marketing">Product Engineering</option>
                        <option value="Sales">Quality Assurance</option>
                        <option value="Operations">After Market</option>
                        <option value="HR">Sales</option>
                        <option value="Finance">Finance & Accounts</option>
                        <option value="HR">HR & IR</option>
                        <option value="HR">Brand & Marketing</option>
                        <option value="HR">PPC & ME</option>
                        <option value="HR">Supply Chain Management</option>
