        ...
        <>
            ...
            <div className="relative h-72 w-full overflow-hidden">
                ...
                <div className="absolute inset-0 z-20 flex items-center pt-8">
                    <div className="max-w-7xl mx-auto px-6 md:px-10 xl:px-20 w-full">
                        ...
                        >
                            <motion.span
                                className="inline-block text-[#F1B434] text-sm font-bold mb-2 mt-8 uppercase"
                                initial={{ opacity: 0 }}
                                animate={{ opacity: 1 }}
            ...
            <section className="py-20 bg-gradient-to-br from-gray-50 to-gray-100">
                <div className="max-w-7xl mx-auto px-6 md:px-10 xl:px-20">
                    ...
                    >
                        {/* Content Header */}
                        <div className="bg-[#F1B434] p-10 text-center">
                            <motion.h2
                        ...
                        <div className="p-10">
                            {contentData.achievements.map((achievement, index) => (
                                <motion.div
                                    ...
                                    className="p-8 bg-gradient-to-r from-gray-50 to-white rounded-2xl border border-gray-200 hover:shadow-lg transition-all duration-300 transform hover:scale-[1.01]"
                                >
